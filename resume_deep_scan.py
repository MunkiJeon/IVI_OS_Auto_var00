...
def finish_remaining_discovery():
    try:
        ...
        for menu in menus:
            ...
            found_menu = False
            for _ in range(3): d.swipe(800, 200, 800, 800, 400) # Reset to top
            
            for s_idx in range(10):
                source = d.page_source
                # Sidebar text is at x: 717
                if menu in source:
